...
export default function PendingApprovalDocumentDetails() {
  ...
  const handleApproveConfirm = () => {
    ...
    setTimeout(() => {
      router.push("/document-submission/my-pending-approval");
    }, 500);
  };
      ...
      <div className="flex w-full items-center justify-center bg-background text-foreground">
        <div className="flex-1">
          <div className="max-w-4xl space-y-3">
            <Link href="/document-submission/my-pending-approval">
              <Button variant="ghost" className="mb-4">
                <ArrowLeft className="mr-2 h-4 w-4" />
                Back to Pending Approval Documents
              </Button>
            </Link>
        ...
        <div className="w-full mx-auto space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete details of the pending approval document
              </CardDescription>
            </CardHeader>
